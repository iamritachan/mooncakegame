...
(function () {
  ...
  function getRank(timeMs, steps) {
    ...
    if (steps <= 9 && sec <= 45) return { zh: "月餅大神 🌕", en: "Mooncake Master" };
    if (steps <= 14 && sec <= 90) return { zh: "賞月高手 🐇", en: "Moon-Gazing Pro" };
    if (steps <= 20) return { zh: "月餅愛好者 🥮", en: "Mooncake Lover" };
    return { zh: "繼續努力的小白兔 ✨", en: "Little Bunny, Keep Going" };
  }
